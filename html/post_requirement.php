            ...
            <form class="listing-form" action="#">
              <div class="row">
                <div class="col-md-6 col-12">
                  ...
                  <textarea rows="10" name="comment" class="form-control" placeholder="write here" id="comment">
                  </textarea>
                </div>
                <div class="col-md-6 col-12">
                  <div class="row">
          ...
          <div class="col-lg-6 col-12 mb-60">
            ...
            <div class="drop-file">
              <a href="#" class="w-100">
                ...
                <p class="mb-0">Drop files here to upload
                </p>
              </a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="listing-submit">
              <button type="submit" class="btn btn-one btn-anim">save listing
              </button>
            </div>
          </div>
        </div>
