          ...
          <div class="menu menu-one">
            <nav class="navbar navbar-expand-lg">
              <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#nav-content" aria-controls="nav-content"
                ...
                <span class="navbar-toggler-icon bar1">
                </span>
                <span class="navbar-toggler-icon bar2">
                </span>
                <span class="navbar-toggler-icon bar3">
                </span>
              </button>
              <!-- Links -->
                ...
                <ul class="navbar-nav ml-auto">
				  ...
				  <li class="nav-item dropdown">
				   ...
				   <ul class="dropdown-menu">
					   ...
					   <li class="dropdown-item">
						   <a href="listing.php">Coworking space</a>
					   </li>
					   <li class="dropdown-item">
						   <a href="listing.php">Private office</a>
					   </li>
					   <li class="dropdown-item">
						   <a href="listing.php">Training room</a>
					   </li>
						<li class="dropdown-item">
						   <a href="listing.php">business center</a>
					   </li>
						<li class="dropdown-item">
						   <a href="listing.php">Coworking cafes</a>
					   </li>
				   </ul>
			      </li>
                  <li class="nav-item">
