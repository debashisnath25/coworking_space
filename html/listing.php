        ...
        <div class="row">
          <div class="col-12">
            ...
            <ul class="banner-link text-center">
              ...
              <li>
                <span class="active">listing with sidebar
                </span>
              </li>
            </ul>
          </div>
                ...
                <div class="col-md-6 col-12 mb-30">
                  <div class="listing-item p-2">
                    ...
                    <div class="list-content p-2">
                      ...
                      <h5 class="mb-2">
                        <a href="listing-detail.html">comfy hotels in town
                        </a>
                      </h5>
                      <p>Donec pede justo, fringilla vel, aliquet nectior
                      </p>
                ...
                <div class="col-12 mb-30">
                  <div class="listing-item p-2">
                    ...
                    <div class="list-content">
                      ...
                      <p>Donec pede justo, fringilla vel, aliquet nectior magna laboris do in.
                      </p>
                      <ul class="ctg-info2 pt-2 mt-3 d-flex justify-content-between flex-wrap">
                        <li class="mt-1">
                          <a href="#">
                      ...
                      <div class="row minus-pad">
                        ...
                        <div class="col-sm-6 col-12">
                          <div class="w-100 mb-2">
                            ...
                            <label for="checkbox_id4">Good 6+
                            </label>
                          </div>
                          <div class="w-100 mb-2">
                            <input type="checkbox" name="checkbox" id="checkbox_id5" value="value">
                            <label for="checkbox_id5">Pleasant 5+
                            </label>
                          </div>
                        </div>
                      </div>
