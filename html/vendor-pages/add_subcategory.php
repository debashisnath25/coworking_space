...
<html lang="en">
  <head>
    ...
    <title>Add Subcategory | Wanted 7</title>
    <?php
            ...
            <div>
				<div class="row">
					<div class="col-lg-12 mb-4">
						<button class="btn btn-primary clr"><span class="btn-icon"><i class="fas fa-plus"></i>Add Subcategory</span></button>
						<a class="btn btn-default del" href="add_category.php" style="background-color: #ccc;color:#000;"><span class="btn-icon"><i class="fas fa-plus"></i>Add Root Category</span></a>
						<button class="btn btn-default del" style="background-color: #ccc;">Delete Subcategory</button>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-3" style="border-right:1px solid #dee2e6;">
										<h5 class="card-title" style="font-size: 15px;">Subcategories</h5>
										<ul class="list-group" id="sortable">
                                            <li class="list-group-item" id="li_name">Fashion<span class="badge badge-success badge-pill" style="float: right;">25</span></li>
											<li class="list-group-item" id="li_name">Jwellery<span class="badge badge-success badge-pill" style="float: right;">5</span></li>
											<li class="list-group-item" id="li_name">Sports<span class="badge badge-success badge-pill" style="float: right;">10</span></li>
											<li class="list-group-item" id="li_name">Electronics<span class="badge badge-success badge-pill" style="float: right;">20</span></li>
                                        </ul>
									</div>
									<div class="col-md-9">
										<h5 class="text-muted mb-4" style="font-size: 15px;">Add New Subcategory</h5>
										<div>
											 <ul class="nav line-tabs">
                                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tab1-1">Genaral</a></li>
                                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab1-2">Subcategory Products</a></li>
                                            </ul>
											<div class="tab-content mt-4">
                                                ...
                                                <div class="tab-pane fade" id="tab1-2">
													<button class="btn btn-primary btn-sm clr" data-toggle="modal" data-target="#exampleLargeModal">Assign Products to Subcategory</button>
