						...
						<div class="tab-pane fade active show" id="faq-group-1">
							...
							<div class="card" style="border:1px solid #7c1ab5">
								<div class="card-header cardhdd">
									<h5 class="box-title" style="color:#fff;">ORDERS RECEIVED AWAITING ACCEPTANCE</h5>
										...
										<table class="table table-bordered table-striped w-100" id="dt-buttons">
											...
											<tbody>
												<tr>
													...
													<td>
														<a href="javascript:void();" class="btn btn-vk btn-sm" type="button">Accept</a>
														<a href="javascript:void();" class="btn btn-vk btn-sm " type="button">Cancel</a>
													</td>
													<td>
														<div class="dropdown"><button class="btn btn-outline-info btn-floating" type="button" data-toggle="dropdown"><i class="ti-more-alt"></i></button>
															<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
																<a class="dropdown-item" href="order_details.php">View Details</a>
												...
												<tr>
													...
													<td>01/02/2019 : 7:00 PM </td>
													<td>
														<a href="discount_details.html" class="btn btn-vk btn-sm" type="button">Accept</a>&nbsp;
														<a href="discount_details.html" class="btn btn-vk btn-sm " type="button">Cancel</a>
													</td>
													<td>
														<div class="dropdown"><button class="btn btn-outline-info btn-floating" type="button" data-toggle="dropdown"><i class="ti-more-alt"></i></button>
															<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
